...
```javascript
snansum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-snansum@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-snansum/tags). For example,

```javascript
snansum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-snansum@v0.0.9-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var snansum = require( 'path/to/vendor/umd/blas-ext-base-snansum/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-snansum@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-snansum/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-snansum/actions/workflows/test.yml?query=branch:v0.0.9
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-snansum.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-snansum/main
